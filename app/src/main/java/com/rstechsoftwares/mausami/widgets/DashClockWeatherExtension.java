package com.rstechsoftwares.mausami.widgets;
...
import com.rstechsoftwares.mausami.activities.SplashActivity;
...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content://com.rstechsoftwares.mausami.authority");
